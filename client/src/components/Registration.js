                                ...
                                <div className="col-12 col-md-6 d-flex justify-content-center align-items-center flex-column">
                                    ...
                                    <form>
                                            ...
                                            <div className="form-group d-flex justify-content-center align-items-center my-2">
                                                ...
                                                <input type="text" className="form_inputs" id="work" name="work" autoComplete="off" aria-describedby="emailHelp" placeholder="Your Proffesion"/>
                                            </div>
                                            ...
                                            <div className="form-group d-flex justify-content-center align-items-center my-2">
                                                ...
                                                <input type="password" className="form_inputs" id="confirmpassword" name="cpassword" autoComplete="off" aria-describedby="emailHelp" placeholder="Enter Confirm Password"/>
                                            </div>
